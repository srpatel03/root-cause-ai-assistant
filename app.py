...
if st.session_state.current_page == "chat":
    st.markdown(
        ...
        <div class="app-title-container">
            ...
            <div class="app-subtitle">A blame-free workspace to guide you through Sentinel Event reviews and clinical process investigations using 5 Whys analysis. <br><i>To start, describe your safety event or operational failure in the input box below and click Submit Response.</i><br><span style="display: inline-block; margin-top: 8px; font-size: 0.78rem; opacity: 0.7;">⚠️ <b>Notice:</b> Content generated by this tool is AI-assisted and must be reviewed and validated by clinical and operational leaders.</span></div>
        </div>
        """),
        unsafe_allow_html=True
    )
